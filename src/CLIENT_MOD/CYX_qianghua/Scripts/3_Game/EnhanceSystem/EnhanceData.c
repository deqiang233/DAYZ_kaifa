...
// Shared data structures used by the client-side enhance UI.

// Material descriptor that travels through RPC.
...
// Result descriptor (success / failure / protection fallback).
...
// Packet sent from the server to render the UI.
