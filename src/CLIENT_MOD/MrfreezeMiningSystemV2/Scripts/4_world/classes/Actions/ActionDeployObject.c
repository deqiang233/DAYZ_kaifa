modded class ActionDeployObject
{
    ...
    {
        if (action_data.m_MainItem.IsKindOf("FreezeAnvil_Kit") || action_data.m_MainItem.IsKindOf("FreezeFurnace_Kit") || action_data.m_MainItem.IsKindOf("FreezeGrindingStone_Kit"))
        {
